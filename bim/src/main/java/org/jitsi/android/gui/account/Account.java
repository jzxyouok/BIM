...
public class Account implements ProviderPresenceStatusListener, RegistrationStateChangeListener, ServiceListener, AvatarListener {
    ...
    Account(AccountID accountID, BundleContext context, Context activityContext) {
        ...
        this.bundleContext = context; this.bundleContext.addServiceListener(this);
    ...
    private Drawable initProtocolIcon() {
        ...
        if (iconPath != null) {
            blob = loadIcon(iconPath); if (blob != null) {
                return AndroidImageUtil.drawableFromBytes(blob);
            }
        }
    ...
    public static byte[] loadIcon(String imagePath) {
        ...
        if (resources != null) {
            ...
            try {
                ...
                byte[] buffer = new byte[1024]; int read; while (-1 != (read = is.read(buffer))) {
    ...
    public void addAccountEventListener(EventListener<AccountEvent> listener) {
        logger.trace("Added change listener " + listener); listeners.addEventListener(listener);
    }
    ...
    public void avatarChanged(AvatarEvent event) {
        logger.trace("Avatar changed notification"); updateAvatar(event.getNewAvatar());
    ...
    public String getStatusName() {
        OperationSetPresence presence = getPresenceOpSet(); if (presence != null) {
    ...
    public Drawable getAvatarIcon() {
        if (avatarIcon == null) {
            ...
            try {
                OperationSetAvatar avatarOpSet = getAvatarOpSet(); if (avatarOpSet != null) {
