...
public class NotificationsTableSettings extends OSGiActivity implements NotificationChangeListener {
    ...
    public void onEnableItemClicked(View v) {
        View parent = (View) v.getParent(); CompoundButton cb = (CompoundButton) v;
    ...
    public void onPopupItemClicked(View v) {
        ...
        boolean isPopup = cb.isChecked(); String eventType = (String) parent.getTag();
    ...
    public void onSoundNotificationItemClicked(View v) {
        ...
        boolean isSoundNotification = cb.isChecked(); String eventType = (String) parent.getTag();
    ...
    public void onSoundPlaybackItemClicked(View v) {
        ...
        boolean isSoundPlayback = cb.isChecked(); String eventType = (String) parent.getTag();
    ...
    public void onVibrateItemClicked(View v) {
        ...
        boolean isVibrate = cb.isChecked(); String eventType = (String) parent.getTag();
