...
public class SecProtocolsDialogFragment extends DialogFragment {
    ...
    public void onDismiss(DialogInterface dialog) {
        super.onDismiss(dialog); if (listener != null) {
    ...
    class ProtocolsAdapter extends BaseAdapter implements TouchInterceptor.DropListener {
        ...
        ProtocolsAdapter(String[] encryptions, Map<String, Boolean> statusMap) {
            this.encryptions = encryptions; this.statusMap = statusMap;
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            TextView tv = (TextView) v.findViewById(android.R.id.text1); tv.setText(encryption);
            ...
            cb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                public void onCheckedChanged(CompoundButton cb, boolean b) {
                    statusMap.put(encryption, b); hasChanges = true;
                }
            });
        ...
        public void drop(int from, int to) {
            ...
            String swap = encryptions[to]; encryptions[to] = encryptions[from];
