...
public class ChatPagerAdapter extends FragmentStatePagerAdapter implements ChatListener {
    ...
    public ChatPagerAdapter(FragmentManager fm, ChatActivity parent) {
        ...
        this.chats = ChatSessionManager.getActiveChatsIDs(); this.parent = parent;
    ...
    public void setPrimaryItem(ViewGroup container, int position, Object object) {
         ...
         */
        ChatFragment newPrimary = (ChatFragment) object; if (newPrimary != primaryItem) {
            if (primaryItem != null) {
    ...
    public void chatCreated(final Chat chat) {
        parent.runOnUiThread(new Runnable() {
            ...
            public void run() {
                synchronized (chats) {
                    chats.add(((ChatSession) chat).getChatId()); notifyDataSetChanged();
                }
            }
        });
    }
