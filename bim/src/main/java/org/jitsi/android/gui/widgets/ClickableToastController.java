...
public class ClickableToastController extends LegacyClickableToastCtrl {
    ...
    public ClickableToastController(View toastView, View.OnClickListener clickListener, int toastButtonId) {
        ...
        // Initialize animator
        toastAnimator = new ObjectAnimator(); toastAnimator.setPropertyName("alpha");
    ...
    public void showToast(boolean immediate, CharSequence message) {
        super.showToast(immediate, message); if (!immediate) {
            toastAnimator.cancel(); toastAnimator.setFloatValues(0, 1);
            toastAnimator.setDuration(SHOW_DURATION); toastAnimator.start();
        }
    }
    ...
    public void hideToast(boolean immediate) {
        super.hideToast(immediate); if (!immediate) {
            toastAnimator.cancel(); toastAnimator.setFloatValues(1, 0);
            toastAnimator.setDuration(HIDE_DURATION); toastAnimator.start();
    ...
    protected void onHide() {
        super.onHide(); toastView.setAlpha(0);
    }
}
