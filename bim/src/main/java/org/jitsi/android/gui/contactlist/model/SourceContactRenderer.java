...
public class SourceContactRenderer implements UIContactRenderer {
    ...
    public String getDisplayName(Object contactImpl) {
        SourceContact contact = (SourceContact) contactImpl; return contact.getDisplayName();
    }

    @Override
    public String getStatusMessage(Object contactImpl) {
        SourceContact contact = (SourceContact) contactImpl; return contact.getDisplayDetails();
    }
