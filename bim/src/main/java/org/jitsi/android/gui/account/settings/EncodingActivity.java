...
public class EncodingActivity extends OSGiActivity implements ActionBarToggleFragment.ActionBarToggleModel {
    ...
    public static List<String> getEncodingsStr(Iterator<MediaFormat> encodings) {
        List<String> outList = new ArrayList<String>(); while (encodings.hasNext()) {
    ...
    public static MediaFormat getEncodingFromStr(Iterator<MediaFormat> encodings, String str) {
        while (encodings.hasNext()) {
            MediaFormat mf = encodings.next(); if (getEncodingStr(mf).equals(str)) {
                return mf;
            }
    ...
    public static List<Integer> getPriorities(List<MediaFormat> encodings, EncodingConfiguration encodingConfig) {
        int count = encodings.size(); List<Integer> priorities = new ArrayList<Integer>(count);
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            Intent result = new Intent(); result.putExtra(EXTRA_KEY_ENC_REG, encReg);
    ...
    public void setChecked(boolean isChecked) {
        isOverrideEncodings = isChecked; encodingsFragment.setEnabled(isOverrideEncodings);
        hasChanges = true;
    }
}
