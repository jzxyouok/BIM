...
public abstract class BaseContactListAdapter extends BaseExpandableListAdapter {
    ...
    public void expandAllGroups() {
        int count = getGroupCount(); if (count <= 0) {
            return;
        }
    ...
    protected void updateStatus(final int groupIndex, final int contactIndex, Object contactImpl) {
        ...
        if (contactView != null) {
            ...
            if (statusView == null) {
                logger.warn("No status view found for " + contactImpl); return;
            }
        ...
        if (isShowVideoCall || isShowCall) {
            ...
            if (renderer.isSelected(child)) {
                ...
                if (isShowVideoCall) {
                    ...
                    contactViewHolder.callButton.setImageResource(R.mipmap.contact_call);
                }
            }
        }
        else {
    ...
    private class AvatarIconClickListener implements View.OnClickListener {
        public void onClick(View view) {
            ...
            int groupPos = viewHolder.groupPosition; int childPos = viewHolder.childPosition;
            Object contact = getChild(groupPos, childPos); if (contact == null) {
                logger.warn("No contact found at " + groupPos + ", " + childPos); return;
            }
