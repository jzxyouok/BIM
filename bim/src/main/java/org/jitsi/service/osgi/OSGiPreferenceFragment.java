...
public class OSGiPreferenceFragment extends PreferenceFragment implements OSGiUiPart {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState); viewCreated = true;
    ...
    public void onDestroyView() {
        viewCreated = false; osgiNotified = false; super.onDestroyView();
    }
    ...
    public void start(BundleContext bundleContext) throws Exception {
        this.osgiContext = bundleContext; if (viewCreated && !osgiNotified) {
            onOSGiConnected();
        }
    }
