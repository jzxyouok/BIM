...
public class FrameworkImpl extends BundleImpl implements Framework {
        ...
        if ((classNames == null) || (classNames.length == 0)) {
            ...
            if (!ServiceFactory.class.isAssignableFrom(serviceClass)) {
                ...
                for (String className : classNames) {
                    boolean illegalArgumentException = true; Throwable cause = null;
    ...
    public void start(int options) throws BundleException {
        ...
        if (state == STARTING) {
            ...
            frameworkStartLevel.setStartLevel(startLevel, listener); synchronized (listener) {
    ...
    protected void stateChanged(int oldState, int newState) {
        switch (newState) {
            case RESOLVED: if (eventDispatcher != null) {
                eventDispatcher.stop(); eventDispatcher = null;
            } synchronized (this) {
                if (frameworkStartLevel != null) {
                    frameworkStartLevel.stop(); frameworkStartLevel = null;
                }
            } break; case STARTING: eventDispatcher = new EventDispatcher(); break;
        }
    ...
    public void stop(int options) throws BundleException {
        ...
        new Thread(getClass().getName() + ".stop") {
            ...
            public void run() {
                ...
                frameworkStartLevel.internalSetStartLevel(0, listener); synchronized (listener) {
                    boolean interrupted = false;
