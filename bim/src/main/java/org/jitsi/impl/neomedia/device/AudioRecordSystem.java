...
public class AudioRecordSystem extends AudioSystem {
    ...
    public static int getFeatureSet() {
        int featureSet = FEATURE_NOTIFY_AND_PLAYBACK_DEVICES; if (AndroidUtils.hasAPI(16)) {
    ...
    protected void doInitialize() throws Exception {
        ...
        captureDevices.add(captureDevice); setCaptureDevices(captureDevices);
        ...
        playbackDevices.add(playbackDevice); playbackDevices.add(notificationDevice);
