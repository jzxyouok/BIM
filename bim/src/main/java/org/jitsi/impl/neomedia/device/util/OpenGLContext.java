...
public class OpenGLContext {
    ...
    public OpenGLContext(boolean recorder, Object window, EGLContext sharedContext) {
        ...
        } int[] majorVersion = new int[1]; int[] minorVersion = new int[1];
    ...
    private EGLConfig chooseEglConfig(EGLDisplay eglDisplay, boolean recorder) {
        EGLConfig[] configs = new EGLConfig[1]; int[] attribList; if (recorder) {
    ...
    public void release() {
        if (eglDisplay != EGL14.EGL_NO_DISPLAY) {
            ...
            EGL14.eglDestroyContext(eglDisplay, eglContext); EGL14.eglReleaseThread();
