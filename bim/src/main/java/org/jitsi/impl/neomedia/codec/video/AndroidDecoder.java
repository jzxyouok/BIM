...
public class AndroidDecoder extends AndroidCodec {
    ...
    protected Format[] getMatchingOutputFormats(Format inputFormat) {
        ...
        VideoFormat inputVideoFormat = (VideoFormat) inputFormat; if (useSurface()) {
    ...
    public Format setOutputFormat(Format format) {
        ...
        VideoFormat videoFormat = (VideoFormat) format; if (format instanceof YUVFormat) {
            YUVFormat yuvFormat = (YUVFormat) videoFormat; outputFormat = new YUVFormat(
                            /* size */ outputSize,
    ...
    protected void onSizeDiscovered(Dimension dimension) {
        outputSize = dimension; setOutputFormat(outputFormat);
    }
}
