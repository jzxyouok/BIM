...
public class DataSource extends AbstractPullBufferCaptureDevice {
    ...
    private static class OpenSLESStream extends AbstractPullBufferStream {
         ...
         * {@link javax.media.protocol.PullBufferStream#read(Buffer)} should
        ...
        public synchronized void disconnect() {
            if (ptr != 0) {
                DataSource.disconnect(ptr); ptr = 0; setThreadPriority = true;
            }
        }
        ...
        public void read(Buffer buffer) throws IOException {
            ...
            buffer.setLength(length); buffer.setOffset(offset);
        }
        ...
        public void start() throws IOException {
            ...
            synchronized (this) {
                if (ptr != 0) {
                    setThreadPriority = true; DataSource.start(ptr); started = true;
                }
            }
        }
        ...
        public void stop() throws IOException {
            synchronized (this) {
                if (ptr != 0) {
                    DataSource.stop(ptr); setThreadPriority = true; started = false;
                }
            }
